...
=== TEST 9: resolver_add directive - no context resolver, adding to default resolver in wasm{} block
--- main_config
    wasm {}
--- config
    resolver_add 127.0.0.1 hostname;
...
=== TEST 10: resolver_add directive - with context resolver, also adding to default resolver in wasm{} block
--- main_config
    wasm {}
--- config
    resolver     1.1.1.1;
...
=== TEST 11: resolver_add directive - with context resolver, also adding to main resolver in wasm{} block
--- main_config
    wasm {
        resolver 8.8.8.8;
    }
