...
--- config
    wasm_isolation noexist;

    location /t {
        return 200;
    }
--- error_log eval
qr/\[emerg\] .*? invalid isolation mode "noexist"/
--- must_die



=== TEST 4: wasm_isolation directive: defaults to "none"
--- skip_no_debug: 3
--- config
    location /t {
...
--- error_log
wasm using "none" isolation mode



=== TEST 5: wasm_isolation 'location': one instance per location
--- skip_no_debug: 3
--- http_config
...
=== TEST 6: wasm_isolation 'request': one instance per request
--- skip_no_debug: 3
--- http_config
...
=== TEST 7: wasm_isolation 'none': one instance per call
--- skip_no_debug: 3
--- http_config
    wasm_isolation none;
...
=== TEST 8: wasm_isolation: nested (1/2)
--- skip_no_debug: 3
--- http_config
    wasm_isolation location;
...
=== TEST 9: wasm_isolation: nested (2/2)
--- skip_no_debug: 3
--- http_config
    wasm_isolation location;
