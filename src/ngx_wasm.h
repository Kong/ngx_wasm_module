...
//typedef void* ngx_wasm_vm_memory_pt;
//typedef void* ngx_wasm_vm_instance_pt;
//typedef void* ngx_wasm_vm_functype_pt;
//typedef void* ngx_wasm_vm_val_pt;
...
typedef ngx_wasm_vm_trap_pt (*ngx_wasm_hostfunc_pt)(void *env,
