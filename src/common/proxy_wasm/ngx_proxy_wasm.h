...
typedef struct ngx_proxy_wasm_stream_ctx_s  ngx_proxy_wasm_stream_ctx_t;
...
struct ngx_proxy_wasm_stream_ctx_s {
    ...
    ngx_proxy_wasm_action_e            next_action;
    void                              *data;
...
ngx_int_t ngx_proxy_wasm_filter_init(ngx_proxy_wasm_filter_t *filterodule);
void ngx_proxy_wasm_filter_destroy(ngx_proxy_wasm_filter_t *filter);

ngx_int_t ngx_proxy_wasm_filter_init_root_instance(
    ngx_proxy_wasm_filter_t *filter);
ngx_int_t ngx_proxy_wasm_filter_init_instance(
    ngx_proxy_wasm_stream_ctx_t *sctx);
...
static ngx_inline ngx_int_t
ngx_proxy_wasm_result_erap(ngx_proxy_wasm_filter_ctx_t *fctx, char *trapmsg,
    wasm_val_t rets[])
{
